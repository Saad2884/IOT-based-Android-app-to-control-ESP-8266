...
class _WebSocketLed extends State<WebSocketLed> {
  ...
  final D8Controller = TextEditingController();
  ...
  void initState() {
    ...
    if (D5Controller.text == "") {
      D5Controller.text = "D5(A)";
    }

    if (D6Controller.text == "") {
      D6Controller.text = "D6(A)";
    }
        ...
        (message) {
          ...
          setState(() {
            if (message == "connected") {
              ...
              D6status = false;
            } else if (message == "D6slow:success") {
              D6level = "slow";
            } else if (message == "D6moderate:success") {
              D6level = "moderate";
            } else if (message == "D6fast:success") {
              D6level = "fast";
            } else if (message == "D7on:success") {
              D7status = true;
            } else if (message == "D7off:success") {
              D7status = false;
            } else if (message == "D8on:success") {
              D8status = true;
            } else if (message == "D8off:success") {
              D8status = false;
            } else if (message == "D8slow:success") {
              D8level = "slow";
            } else if (message == "D8moderate:success") {
              D8level = "moderate";
            } else if (message == "D8fast:success") {
              D8level = "fast";
            }
          });
        },
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage("assets/images/esp8266logo.png"),
                            opacity: 0.5,
                            fit: BoxFit.fill,
                          ),
                        ),
              ...
              child: Stack(
                children: [
                  Container(
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage("assets/images/tech3.jpg"),
                        opacity: 0.8,
                        fit: BoxFit.fitWidth,
                      ),
                    ),
          ...
          children: [
            Container(
              ...
              child: FlatButton(
                  ...
                  onPressed: () {
                    ...
                    if (D8modeA == false) {
                      if (D8status == true) {
                        sendcmd("D8off");
                        D8status = false;
                      } else if (D8status == false) {
                        sendcmd("D8on");
                        D8status = true;
                      }
                    } else if (D8modeA = true) {
                      if ((D8level == "slow") && (D8status == false)) {
                        sendcmd("D8slow");
                        D8status = true;
                      } else if ((D8level == "moderate") &&
                          (D8status == false)) {
                        sendcmd("D8moderate");
                        D8status = true;
                      } else if ((D8level == "fast") && (D8status == false)) {
                        sendcmd("D8fast");
                        D8status = true;
                      } else if ((D8level == "on") && (D8status == false)) {
                        sendcmd("D8on");
                        D8status = true;
                      } else if (D8status = true) {
                        sendcmd("D8off");
                        D8status = false;
                      }
                    }
                  ...
                  color: D8status ? Colors.green : Colors.red,
                  child: Text(D8Controller.text)),
            ),
            SizedBox(
              height: 5.0,
            ),
            D8status
                ? Text(D8Controller.text + " is ON")
                : Text(D8Controller.text + " is OFF"),
          ],
        ),
      ],
    );
